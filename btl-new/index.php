...
<div class="header">
    ...
    <div class="menu">
        <ul class="clearfix">
            ...
            <li><a href="http://localhost/btl-new/BangDiem.php"> XEM DIỂM </a></li>
        </ul>
    </div>
    ...
    <div class="main">
        <div class="item">
                ...
                <img src="img/thong-bao.jpg" alt="" class="image">
        ...
        <div class="item">
                ...
                <img src="img/begiang.jpg" alt="" class="image">
