        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Chọn cách ThêmSV</h5>
                ...
                <div class="panelSV">
                    ...
                    <div class="row">
                        <form class="fmcenter" style="margin-left:40px">
                            ...
                            <input type="text" name="" class="form-control" placeholder="Mã Sinh Viên....">
                   ...
                   <div class="them" style="display:flex ">
                        ...
                        <div class="col-6 d-flex justify-content-end align-items-center">
                                ...
                                <img src="//calendar.google.com/googlecalendar/images/icon_print.gif" style="cursor: pointer;" width="16" height="16" title="In SV">Print
                        </div>
                    ...
                    <div class="table">
                         <?php
                                ...
                                include('config.php');
                                $sql='SELECT sv.ID,LopID,HoTen, lp.TenLop ,kh.TenKhoa,NgaySinh,gioitinh,KhoaHoc,Email FROM sinhvien sv,lop lp,khoa kh
                                WHERE sv.LopID=lp.ID AND lp.KhoaID=kh.ID';                            
                                $result= mysqli_query($conn,$sql);
                                echo "<table border='1' cellpadding='10' method='post'>";
                                echo "<tr>
                                <th><font color='Red'>Mã Sinh Viên</font></th>
                                <th><font color='Red'>ID Lớp</font></th>
                                <th><font color='Red'>Họ Tên</font></th>
                                <th><font color='Red'> Lớp</font></th>
                                <th><font color='Red'>Khoa</font></th>
                                <th ><font color='Red'>Ngày Sinh</font></th>
                                <th ><font color='Red'>Giới Tính</font></th>
                                <th ><font color='Red'>Khóa Học</font></th>
